...
export class CoursesComponent {
  items = [
    ...
    { image: './assets/courses-images/linux.jpg' ,title: 'Linux', description: 'Master the Linux operating system through our online coaching program. Led by experienced professionals, you will gain hands-on expertise in Linux administration, boosting your employability in the IT sector.' },
    { image: './assets/courses-images/devops.jpg' ,title: 'DevOps', description: 'Learn the principles of DevOps and streamline software development processes with our online coaching. Our expert instructors will guide you through the implementation of DevOps tools and methodologies, paving the way for exciting career opportunities.' },
    { image: './assets/courses-images/python.jpg' ,title: 'MEAN Stack', description: 'Embark on a journey into full-stack development with our online coaching in the MEAN stack. From MongoDB to Angular, our seasoned mentors will provide comprehensive guidance, empowering you to build dynamic web applications and secure rewarding job placements.' },
